...
Labels follow the generation prompt: HIGH prompts are intended to produce HIGH-signal transcripts,
though prompt adherence is not guaranteed (see Section 4.2).
